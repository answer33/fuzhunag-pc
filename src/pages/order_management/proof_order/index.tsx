...
const ProofOrder: FC<any> = () => {
  ...
  return (
    <div className={styles['proof-order']}>
      <Form
        form={form}
      ...
      >
        <Row justify="space-between">
          <Col span={12}>
            <Button
              type="primary"
              onClick={() => history.push('/order_management/proof_order/add')}
            >
              新增打样订单
            </Button>
          </Col>
      ...
      <div className={styles.table}>
        <Tabs onChange={onChangeTab} type="card">
          ...
          <TabPane tab="已收货" key="4"></TabPane>
          <TabPane tab="给客户发货" key="5"></TabPane>
          <TabPane tab="已完成" key="6"></TabPane>
        </Tabs>
...
export default memo(ProofOrder);
