...
import { Col, Row, Form, Select, Button, Table } from 'antd';
...
const User: FC<any> = () => {
  ...
  return (
    <div className={styles['factory-detail']}>
      <div className={styles['user-info']}>
        <img src="" alt="" />
        <div>
          <p>张三</p>
          <p>
            <span>启用</span>13600001234
          </p>
        </div>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.consume}>
          ...
          <Row style={{ color: '#9B9B9B', paddingLeft: 20 }}>
            <Col span={5}>余额(元)</Col>
            <Col span={5}>本月提现(元)</Col>
            <Col span={5}>本月累计接单金额(元)</Col>
            <Col span={4}>本月累计接单次数</Col>
            <Col span={4}>上次接单时间</Col>
          </Row>
          <Row style={{ color: '#686868', paddingLeft: 20 }}>
            <Col span={5}>
              ¥52,450.00
              <span
